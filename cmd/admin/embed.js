...
module.exports.run = async (client , message, args)  => {
    ...
    const msgwait = await message.channel.send("Chargement... <a:Loading:844681011345358919>");
 ...
 module.exports.help = {
   ...
   aliases : [''],
   category: "admin",
   description: "Permet de générer des embeds",
   usage : '',
   isUserAdmin: false,
